...
public class RelativeCoordinates {
    ...
    public static Iterable<Location> getAbsoluteLocations(Iterable<RelativeCoordinates> list, Location origin){
    ...
    public static Iterable<RelativeCoordinates> getRelativeCoordinates(Iterable<Location> locs, Location origin){
    ...
    public static Iterable<Location> getAbsoluteLocationsWithinTwoLocations(Location loc1, Location loc2){
...
//
//    public static Iterable<Location> rotateLocationsCounterClockwiseXAboutOrigin(Double degrees, Iterable<Location> locs, Location origin){
//        Iterable<RelativeCoordinates> newLocs = getRelativeCoordinates(locs, origin);
//        for (RelativeCoordinates r : newLocs){
//            Double preRadians = Math.acos(r.getX());
//            Double radians = preRadians + Math.toRadians(degrees);
//            double newX = Math.cos(radians);
//            double newY = Math.sin(radians);
//            double newZ =
//        }
//    }
//
//    public static Iterable<Location> rotateLocationsCounterClockwiseX(Iterable<Location> locs, Double degrees){
//        double smallX;
//        double bigX;
//        for(Location loc: locs){
//            if()
